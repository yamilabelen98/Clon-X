    ...
    <header>
      {!session ? (
        <button
          ...
          type="button"
          className="text-white bg-[#24292F] focus:ring-4 focus:outline-none focus:ring-[#24292F]/50 text-medium font-semibold rounded-full px-8 py-3 text-center inline-flex items-center focus:ring-gray-500 hover:bg-[#050708]/30 "
        >
          <svg
